// server.js
const express = require('express'); // Express framework - handles http requests and builds a server
const dotenv = require('dotenv');   // Dotenv library - lets me load environment variables from a .env file
...
// Serve compiled CSS/JS from dist
app.use('/dist', express.static(path.join(__dirname, 'dist')));
// Serve root files (index.html, images, etc.)
